...
select
  ...
  dbo.TEDS_XWALK_FREQ_ATND_SELF_HELP_D.value as AttendanceAtSubstanceUseSelfHelpGroupsInPast30B4Discharge
into dbo.TEDS_D_2021
from 
...
-- created 1,455 records when run just on 2020 data, which matches the number of Hawaii entries in the  dbo.TEDS_D_combined_data_Hawaii_2015_2021 table.
